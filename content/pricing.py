# 코스별 기본 요금 블록 — 메인·지역·역·생활권 페이지 공용 컴포넌트
# 숫자 변경 시 이 파일 한 곳만 수정하면 전체 페이지에 반영된다.
...
<p class="price-note">지역·예약 시간대·이동 거리에 따라 상담 시 최종 확인됩니다. <a href="/reservation/#payment">결제·요금 안내 보기 →</a></p>
</section>
"""
